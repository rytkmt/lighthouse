...
exe "hi! DiffAdd"                .s:bg_col("#2c4733")
exe "hi! DiffDelete"             .s:fg_col("#622323")      .s:bg_col("#622323")
exe "hi! DiffChange"                   .s:bg_col("#29294a")
exe "hi! DiffText"               .s:fg_col4 .s:bg_col("#635c32")
